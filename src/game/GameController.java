...
public class GameController {
    ...
    public void refreshAchievements(int tick) {
        ...
        //double survivorProgress = calculateSurivorProgress();
       // double exterminatorProgress = calculateExterminatorProgress();
       //double accuracyProgress = calculateSharpShooterProgress();
