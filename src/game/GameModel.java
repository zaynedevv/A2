...
public class GameModel {
    ...
    public GameModel(Logger log, PlayerStatsTracker playerStatsTracker) {
        if (log == null || playerStatsTracker == null) {
    ...
    /**
     * Retrieves the player stats tracker
     * @return the player stats tracker object
     */
    ...
    /**
     * Checks whether a space object exists at a given x, y coordinate
     * @param x the x-coordinate
     * @param y the y-coordinate
     * @return boolean indicating whether a spaceobject exists there
     */
