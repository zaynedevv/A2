...
/**
 * Player stats tracker object tracks player metrics throughout the game
 * - startTime
 * - shotsFired
 * - shotsHit
 */
public class PlayerStatsTracker {
    ...
    /// The start time to measure from for the program
    private long startTime;

    /// Total shots fired by the player
    private int shotsFired;

    /// Shots hit by the player
